...
public class PreyImpl extends AbstractAgent implements Agent{
	...
	public INDArray getObservations() {
		...
		Optional<? extends Tuple> agent_vel = tuples.get("prey-velocity");
		...
		Optional<? extends Tuple> agent_loc = tuples.get("prey-loc");
		...
		Optional<? extends Tuple> agent2_loc = tuples.get("predator2-loc");
		...
		Optional<? extends Tuple> agent3_loc = tuples .get("predator3-loc");
