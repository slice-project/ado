...
public class Predator3Impl extends AbstractAgent {
	
	public Predator3Impl() {
	...
	public INDArray getObservations() {
		...
		Optional<? extends Tuple> agent_vel = tuples.get("predator3-velocity");
		...
		Optional<? extends Tuple> agent_loc = tuples.get("predator3-loc");
