from multiagent.core_ado import World, Agent, Landmark
...
class Scenario(BaseScenario):
    ...
    def reset_world(self, world):
        ...
        for agent in world.agents:
            ...
            if agent.movable:
                agent_stub = world.ado_stub.get_agent_by_id(agent.name)
                agent_stub.set_action('MoveToXY', [agent.state.p_pos[0], agent.state.p_pos[1]])
    ...
    def observation(self, agent, world):
        ...
        # listener
        if agent.silent:
            xxx = np.concatenate([agent.state.p_vel] + entity_pos + comm)
            print("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
            print(xxx)
            print("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
